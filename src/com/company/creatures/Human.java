...
public class Human extends Animal {
    ...
    public void save() throws SQLClientInfoException {
        String sql = "insert into public.human values(DEFAULT,'" + this.firstName + "','" + this.lastName + "'," + this.getSalary() + "," + this.getCash() + ")";
